...
type Comment struct {
	gorm.Model
	Cid           uint   `gorm:"comment:内容ID;index:idx_comment_cid_type"`
	...
	ParentId      uint   `gorm:"default:0;comment:所属评论ID;index"`
	Type          int    `gorm:"size:1;default:0;comment:类型:0视频、1文章;index:idx_comment_cid_type"`
}
